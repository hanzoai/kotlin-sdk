...
dependencies {
    testImplementation(project(":hanzo-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../hanzo-kotlin-core/src/main/resources/META-INF/proguard/hanzo-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("ai.hanzo.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../hanzo-kotlin-core/src/main/resources/META-INF/proguard/hanzo-kotlin-core.pro",
