...
internal class UpdateDeploymentTest {
    ...
    fun create() {
        ...
        assertThat(updateDeployment.llmParams())
            .isEqualTo(
                UpdateDeployment.LlmParams.builder()
                    .apiBase("api_base")
                    .apiKey("api_key")
        ...
        assertThat(updateDeployment.modelInfo())
            .isEqualTo(
                ModelInfo.builder()
                    .id("id")
                    .baseModel("base_model")
    ...
    fun roundtrip() {
        ...
        val roundtrippedUpdateDeployment =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(updateDeployment),
                jacksonTypeRef<UpdateDeployment>(),
            )

        assertThat(roundtrippedUpdateDeployment).isEqualTo(updateDeployment)
    }
}
