...
internal class SpendRetrieveReportResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedSpendRetrieveReportResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(spendRetrieveReportResponse),
                jacksonTypeRef<SpendRetrieveReportResponse>(),
            )

        assertThat(roundtrippedSpendRetrieveReportResponse).isEqualTo(spendRetrieveReportResponse)
    }
}
