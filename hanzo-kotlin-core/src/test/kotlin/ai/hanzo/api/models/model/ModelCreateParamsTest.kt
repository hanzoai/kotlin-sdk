...
internal class ModelCreateParamsTest {
    ...
    fun bodyWithoutOptionalFields() {
        val params =
            ModelCreateParams.builder()
                .litellmParams(ModelCreateParams.LitellmParams.builder().model("model").build())
        ...
        assertThat(body.litellmParams())
            .isEqualTo(ModelCreateParams.LitellmParams.builder().model("model").build())
