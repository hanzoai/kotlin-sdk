...
private constructor(
    ...
    /** A builder for [AzurePatchParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(azurePatchParams: AzurePatchParams) = apply {
            endpoint = azurePatchParams.endpoint
            additionalHeaders = azurePatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = azurePatchParams.additionalQueryParams.toBuilder()
