...
private constructor(
    ...
    companion object {
        ...
        fun none(): GenerationCreateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GenerationCreateParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [GenerationCreateParams].
         *
