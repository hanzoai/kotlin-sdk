...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): CustomerListParams =
            CustomerListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerListParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "CustomerListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
