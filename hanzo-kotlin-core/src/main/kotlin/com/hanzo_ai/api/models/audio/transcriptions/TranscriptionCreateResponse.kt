...
package com.hanzo_ai.api.models.audio.transcriptions
...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): TranscriptionCreateResponse =
            TranscriptionCreateResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TranscriptionCreateResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "TranscriptionCreateResponse{additionalProperties=$additionalProperties}"
}
