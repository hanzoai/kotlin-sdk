...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(azureCallParams: AzureCallParams) = apply {
            endpoint = azureCallParams.endpoint
            additionalHeaders = azureCallParams.additionalHeaders.toBuilder()
