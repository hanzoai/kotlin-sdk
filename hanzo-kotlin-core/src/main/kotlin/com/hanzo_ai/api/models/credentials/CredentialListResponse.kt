...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): CredentialListResponse =
            CredentialListResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CredentialListResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "CredentialListResponse{additionalProperties=$additionalProperties}"
}
