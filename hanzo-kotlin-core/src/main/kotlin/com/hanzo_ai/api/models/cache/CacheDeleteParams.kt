...
private constructor(
    ...
    companion object {
        ...
        fun none(): CacheDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CacheDeleteParams]. */
        fun builder() = Builder()
    }

    /** A builder for [CacheDeleteParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(cacheDeleteParams: CacheDeleteParams) = apply {
            additionalHeaders = cacheDeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = cacheDeleteParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = cacheDeleteParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CacheDeleteParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CacheDeleteParams =
            CacheDeleteParams(
