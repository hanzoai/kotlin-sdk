...
interface GuardrailService {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): GuardrailService
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): GuardrailService.WithRawResponse
