...
interface OrganizationServiceAsync {
    ...
    /** @see update */
    suspend fun update(requestOptions: RequestOptions): OrganizationTableWithMembers =
    ...
    /** @see list */
    suspend fun list(requestOptions: RequestOptions): List<OrganizationTableWithMembers> =
