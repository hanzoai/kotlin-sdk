...
class EuAssemblyaiServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): EuAssemblyaiServiceAsync =
        EuAssemblyaiServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
