...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = userApiKeyAuth.aliases().convert(MyClass::class.java)
             * ```
             */
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = userApiKeyAuth.config().convert(MyClass::class.java)
             * ```
             */
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = userApiKeyAuth.llmBudgetTable().convert(MyClass::class.java)
             * ```
             */
            @JsonProperty("llm_budget_table")
            @ExcludeMissing
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = userApiKeyAuth.metadata().convert(MyClass::class.java)
             * ```
             */
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = userApiKeyAuth.modelMaxBudget().convert(MyClass::class.java)
             * ```
             */
            @JsonProperty("model_max_budget")
            @ExcludeMissing
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = userApiKeyAuth.modelSpend().convert(MyClass::class.java)
             * ```
             */
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = userApiKeyAuth.permissions().convert(MyClass::class.java)
             * ```
             */
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = userApiKeyAuth.teamMetadata().convert(MyClass::class.java)
             * ```
             */
            @JsonProperty("team_metadata")
            @ExcludeMissing
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = userApiKeyAuth.teamModelAliases().convert(MyClass::class.java)
             * ```
             */
            @JsonProperty("team_model_aliases")
            @ExcludeMissing
