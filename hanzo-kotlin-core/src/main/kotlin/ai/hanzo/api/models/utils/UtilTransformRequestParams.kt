...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = utilTransformRequestParams.requestBody().convert(MyClass::class.java)
     * ```
     */
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = body.requestBody().convert(MyClass::class.java)
         * ```
         */
