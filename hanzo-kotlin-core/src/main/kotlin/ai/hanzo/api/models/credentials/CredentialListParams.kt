...
private constructor(
    ...
    companion object {
        ...
        fun none(): CredentialListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): CredentialListParams =
            CredentialListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CredentialListParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "CredentialListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
