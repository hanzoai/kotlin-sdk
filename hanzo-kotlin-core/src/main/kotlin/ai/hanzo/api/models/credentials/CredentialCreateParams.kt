...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = credentialCreateParams.credentialInfo().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = credentialCreateParams.credentialValues().convert(MyClass::class.java)
     * ```
     */
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = body.credentialInfo().convert(MyClass::class.java)
         * ```
         */
        @JsonProperty("credential_info")
        @ExcludeMissing
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = body.credentialValues().convert(MyClass::class.java)
         * ```
         */
        @JsonProperty("credential_values")
        @ExcludeMissing
