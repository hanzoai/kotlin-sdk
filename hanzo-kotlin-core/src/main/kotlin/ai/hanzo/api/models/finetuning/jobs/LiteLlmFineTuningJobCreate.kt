...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LiteLlmFineTuningJobCreate].
         *
    ...
    /** A builder for [LiteLlmFineTuningJobCreate]. */
    class Builder internal constructor() {
        ...
        internal fun from(liteLlmFineTuningJobCreate: LiteLlmFineTuningJobCreate) = apply {
            model = liteLlmFineTuningJobCreate.model
            trainingFile = liteLlmFineTuningJobCreate.trainingFile
            customLlmProvider = liteLlmFineTuningJobCreate.customLlmProvider
            hyperparameters = liteLlmFineTuningJobCreate.hyperparameters
            integrations = liteLlmFineTuningJobCreate.integrations.map { it.toMutableList() }
            seed = liteLlmFineTuningJobCreate.seed
            suffix = liteLlmFineTuningJobCreate.suffix
            validationFile = liteLlmFineTuningJobCreate.validationFile
            additionalProperties = liteLlmFineTuningJobCreate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LiteLlmFineTuningJobCreate].
         *
         ...
         */
        fun build(): LiteLlmFineTuningJobCreate =
    ...
    fun validate(): LiteLlmFineTuningJobCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LiteLlmFineTuningJobCreate &&
            model == other.model &&
    ...
    override fun toString() =
        "LiteLlmFineTuningJobCreate{model=$model, trainingFile=$trainingFile, customLlmProvider=$customLlmProvider, hyperparameters=$hyperparameters, integrations=$integrations, seed=$seed, suffix=$suffix, validationFile=$validationFile, additionalProperties=$additionalProperties}"
}
