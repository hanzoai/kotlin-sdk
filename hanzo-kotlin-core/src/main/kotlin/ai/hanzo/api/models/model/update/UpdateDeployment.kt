...
import ai.hanzo.api.models.model.ConfigurableClientsideParamsCustomAuth
...
private constructor(
     ...
     */
    fun llmParams(): LlmParams? = llmParams.getNullable("llm_params")
    ...
    private constructor(
         ...
         * ```kotlin
         * val myObject: MyClass = llmParams.modelInfo().convert(MyClass::class.java)
         * ```
         */
