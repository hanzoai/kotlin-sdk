...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): ContentRetrieveResponse =
            ContentRetrieveResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContentRetrieveResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "ContentRetrieveResponse{additionalProperties=$additionalProperties}"
}
