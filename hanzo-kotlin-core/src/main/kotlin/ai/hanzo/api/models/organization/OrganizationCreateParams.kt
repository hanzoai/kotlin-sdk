...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = organizationCreateParams.metadata().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = organizationCreateParams.modelMaxBudget().convert(MyClass::class.java)
     * ```
     */
