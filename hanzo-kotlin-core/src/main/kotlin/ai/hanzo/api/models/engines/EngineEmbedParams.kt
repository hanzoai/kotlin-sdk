...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EngineEmbedParams].
         *
    ...
    /** A builder for [EngineEmbedParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(engineEmbedParams: EngineEmbedParams) = apply {
            pathModel = engineEmbedParams.pathModel
            body = engineEmbedParams.body.toBuilder()
            additionalHeaders = engineEmbedParams.additionalHeaders.toBuilder()
            additionalQueryParams = engineEmbedParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EngineEmbedParams].
         *
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{bodyModel=$bodyModel, apiBase=$apiBase, apiKey=$apiKey, apiType=$apiType, apiVersion=$apiVersion, caching=$caching, customLlmProvider=$customLlmProvider, input=$input, litellmCallId=$litellmCallId, litellmLoggingObj=$litellmLoggingObj, loggerFn=$loggerFn, timeout=$timeout, user=$user, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EngineEmbedParams &&
    ...
    override fun toString() =
        "EngineEmbedParams{pathModel=$pathModel, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
