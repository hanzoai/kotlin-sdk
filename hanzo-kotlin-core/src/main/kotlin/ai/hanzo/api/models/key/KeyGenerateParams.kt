...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = keyGenerateParams.aliases().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyGenerateParams.config().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyGenerateParams.metadata().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyGenerateParams.modelMaxBudget().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyGenerateParams.modelRpmLimit().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyGenerateParams.modelTpmLimit().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyGenerateParams.permissions().convert(MyClass::class.java)
     * ```
     */
