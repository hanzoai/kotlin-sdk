...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = keyBlockResponse.aliases().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyBlockResponse.config().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyBlockResponse.llmBudgetTable().convert(MyClass::class.java)
     * ```
     */
    @JsonProperty("llm_budget_table")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyBlockResponse.metadata().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyBlockResponse.modelMaxBudget().convert(MyClass::class.java)
     * ```
     */
    @JsonProperty("model_max_budget")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyBlockResponse.modelSpend().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = keyBlockResponse.permissions().convert(MyClass::class.java)
     * ```
     */
