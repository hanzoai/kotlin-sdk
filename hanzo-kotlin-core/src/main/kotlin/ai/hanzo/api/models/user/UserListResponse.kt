...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): UserListResponse = UserListResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UserListResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "UserListResponse{additionalProperties=$additionalProperties}"
}
