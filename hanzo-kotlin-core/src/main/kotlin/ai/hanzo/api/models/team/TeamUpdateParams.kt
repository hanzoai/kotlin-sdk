...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = teamUpdateParams.metadata().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = teamUpdateParams.modelAliases().convert(MyClass::class.java)
     * ```
     */
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = body.modelAliases().convert(MyClass::class.java)
         * ```
         */
