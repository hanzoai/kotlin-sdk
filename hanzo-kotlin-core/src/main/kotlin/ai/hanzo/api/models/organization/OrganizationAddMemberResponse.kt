...
private constructor(
    ...
    private constructor(
         ...
         * ```kotlin
         * val myObject: MyClass = updatedOrganizationMembership.user().convert(MyClass::class.java)
         * ```
         */
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is UpdatedOrganizationMembership &&
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = updatedUser.metadata().convert(MyClass::class.java)
         * ```
         */
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = updatedUser.modelMaxBudget().convert(MyClass::class.java)
         * ```
         */
        @JsonProperty("model_max_budget")
        @ExcludeMissing
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = updatedUser.modelSpend().convert(MyClass::class.java)
         * ```
         */
        ...
        private constructor(
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = organizationMembership.user().convert(MyClass::class.java)
             * ```
             */
            @JsonProperty("user") @ExcludeMissing fun _user(): JsonValue = user
