...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = organizationListResponse.metadata().convert(MyClass::class.java)
     * ```
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationListResponse: OrganizationListResponse) = apply {
            budgetId = organizationListResponse.budgetId
            createdAt = organizationListResponse.createdAt
            createdBy = organizationListResponse.createdBy
            models = organizationListResponse.models.map { it.toMutableList() }
            updatedAt = organizationListResponse.updatedAt
            updatedBy = organizationListResponse.updatedBy
            llmBudgetTable = organizationListResponse.llmBudgetTable
            members = organizationListResponse.members.map { it.toMutableList() }
            metadata = organizationListResponse.metadata
            organizationAlias = organizationListResponse.organizationAlias
            organizationId = organizationListResponse.organizationId
            spend = organizationListResponse.spend
            teams = organizationListResponse.teams.map { it.toMutableList() }
