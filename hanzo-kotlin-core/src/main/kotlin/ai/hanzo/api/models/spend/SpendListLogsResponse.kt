...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = spendListLogsResponse.metadata().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = spendListLogsResponse.requestTags().convert(MyClass::class.java)
     * ```
     */
