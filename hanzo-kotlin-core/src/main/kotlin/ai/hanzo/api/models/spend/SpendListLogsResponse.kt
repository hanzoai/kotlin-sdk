...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SpendListLogsResponse].
         *
    ...
    /** A builder for [SpendListLogsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(spendListLogsResponse: SpendListLogsResponse) = apply {
            apiKey = spendListLogsResponse.apiKey
            callType = spendListLogsResponse.callType
            endTime = spendListLogsResponse.endTime
            messages = spendListLogsResponse.messages
            requestId = spendListLogsResponse.requestId
            response = spendListLogsResponse.response
            startTime = spendListLogsResponse.startTime
            apiBase = spendListLogsResponse.apiBase
            cacheHit = spendListLogsResponse.cacheHit
            cacheKey = spendListLogsResponse.cacheKey
            completionTokens = spendListLogsResponse.completionTokens
            metadata = spendListLogsResponse.metadata
            model = spendListLogsResponse.model
            promptTokens = spendListLogsResponse.promptTokens
            requestTags = spendListLogsResponse.requestTags
            requesterIpAddress = spendListLogsResponse.requesterIpAddress
            spend = spendListLogsResponse.spend
            totalTokens = spendListLogsResponse.totalTokens
            user = spendListLogsResponse.user
            additionalProperties = spendListLogsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SpendListLogsResponse].
         *
         ...
         */
        fun build(): SpendListLogsResponse =
    ...
    fun validate(): SpendListLogsResponse = apply {
        if (validated) {
            return@apply
        }
