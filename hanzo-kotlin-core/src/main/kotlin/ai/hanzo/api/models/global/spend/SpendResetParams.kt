...
private constructor(
    ...
    companion object {
        ...
        fun none(): SpendResetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SpendResetParams]. */
        fun builder() = Builder()
    }

    /** A builder for [SpendResetParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(spendResetParams: SpendResetParams) = apply {
            additionalHeaders = spendResetParams.additionalHeaders.toBuilder()
            additionalQueryParams = spendResetParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = spendResetParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SpendResetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SpendResetParams =
            SpendResetParams(
