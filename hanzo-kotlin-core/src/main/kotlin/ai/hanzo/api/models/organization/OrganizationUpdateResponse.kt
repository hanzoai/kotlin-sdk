...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = organizationUpdateResponse.metadata().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationUpdateResponse].
         *
    ...
    /** A builder for [OrganizationUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(organizationUpdateResponse: OrganizationUpdateResponse) = apply {
            budgetId = organizationUpdateResponse.budgetId
            createdAt = organizationUpdateResponse.createdAt
            createdBy = organizationUpdateResponse.createdBy
            models = organizationUpdateResponse.models.map { it.toMutableList() }
            updatedAt = organizationUpdateResponse.updatedAt
            updatedBy = organizationUpdateResponse.updatedBy
            llmBudgetTable = organizationUpdateResponse.llmBudgetTable
            members = organizationUpdateResponse.members.map { it.toMutableList() }
            metadata = organizationUpdateResponse.metadata
            organizationAlias = organizationUpdateResponse.organizationAlias
            organizationId = organizationUpdateResponse.organizationId
            spend = organizationUpdateResponse.spend
            teams = organizationUpdateResponse.teams.map { it.toMutableList() }
            additionalProperties = organizationUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationUpdateResponse].
         *
         ...
         */
        fun build(): OrganizationUpdateResponse =
    ...
    fun validate(): OrganizationUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrganizationUpdateResponse &&
            budgetId == other.budgetId &&
            createdAt == other.createdAt &&
            createdBy == other.createdBy &&
            models == other.models &&
