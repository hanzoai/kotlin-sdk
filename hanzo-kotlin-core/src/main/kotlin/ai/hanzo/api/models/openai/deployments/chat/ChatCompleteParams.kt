...
private constructor(
    private val pathModel: String?,
    private val body: Body,
    private val additionalHeaders: Headers,
    private val additionalQueryParams: QueryParams,
) : Params {

    fun pathModel(): String? = pathModel
     ...
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    fun bodyModel(): String = body.bodyModel()
    ...
    /**
     * Returns the raw JSON value of [bodyModel].
     *
     * Unlike [bodyModel], this method doesn't throw if the JSON field has an unexpected type.
     */
    fun _bodyModel(): JsonField<String> = body._bodyModel()
    ...
    /** A builder for [ChatCompleteParams]. */
    class Builder internal constructor() {

        private var pathModel: String? = null
        private var body: Body.Builder = Body.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(chatCompleteParams: ChatCompleteParams) = apply {
            pathModel = chatCompleteParams.pathModel
            body = chatCompleteParams.body.toBuilder()
            additionalHeaders = chatCompleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = chatCompleteParams.additionalQueryParams.toBuilder()
        }

        fun pathModel(pathModel: String?) = apply { this.pathModel = pathModel }
        ...
        fun bodyModel(bodyModel: String) = apply { body.bodyModel(bodyModel) }

        /**
         * Sets [Builder.bodyModel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.bodyModel] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun bodyModel(bodyModel: JsonField<String>) = apply { body.bodyModel(bodyModel) }
    ...
    private constructor(
        ...
        private val bodyModel: JsonField<String>,
        ...
        private constructor(
            ...
            @JsonProperty("model") @ExcludeMissing bodyModel: JsonField<String> = JsonMissing.of(),
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun bodyModel(): String = bodyModel.getRequired("model")
         ...
         * Unlike [bodyModel], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("model") @ExcludeMissing fun _bodyModel(): JsonField<String> = bodyModel
        ...
        class Builder internal constructor() {
            ...
            private var bodyModel: JsonField<String>? = null
            ...
            fun bodyModel(bodyModel: String) = bodyModel(JsonField.of(bodyModel))
             ...
             * supported value.
             */
            fun bodyModel(bodyModel: JsonField<String>) = apply { this.bodyModel = bodyModel }
            ...
            fun build(): Body =
                Body(
                    ...
                    checkRequired("bodyModel", bodyModel),
                    caching,
                    contextWindowFallbackDict,
        ...
        internal fun validity(): Int =
            (messages.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (bodyModel.asKnown() == null) 0 else 1) +
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    override fun toString(): String =
                        when {
                            chatCompletionTextObject != null ->
                                "UnnamedSchemaWithArrayParent0{chatCompletionTextObject=$chatCompletionTextObject}"
                            chatCompletionImageObject != null ->
                                "UnnamedSchemaWithArrayParent0{chatCompletionImageObject=$chatCompletionImageObject}"
                            chatCompletionAudioObject != null ->
                                "UnnamedSchemaWithArrayParent0{chatCompletionAudioObject=$chatCompletionAudioObject}"
                            chatCompletionDocumentObject != null ->
                                "UnnamedSchemaWithArrayParent0{chatCompletionDocumentObject=$chatCompletionDocumentObject}"
                            chatCompletionVideoObject != null ->
                                "UnnamedSchemaWithArrayParent0{chatCompletionVideoObject=$chatCompletionVideoObject}"
                            chatCompletionFileObject != null ->
                                "UnnamedSchemaWithArrayParent0{chatCompletionFileObject=$chatCompletionFileObject}"
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    override fun toString(): String =
                        when {
                            chatCompletionTextObject != null ->
                                "UnnamedSchemaWithArrayParent1{chatCompletionTextObject=$chatCompletionTextObject}"
                            chatCompletionThinkingBlock != null ->
                                "UnnamedSchemaWithArrayParent1{chatCompletionThinkingBlock=$chatCompletionThinkingBlock}"
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChatCompleteParams &&
            pathModel == other.pathModel &&
            body == other.body &&
    ...
    override fun hashCode(): Int =
        Objects.hash(pathModel, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ChatCompleteParams{pathModel=$pathModel, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
