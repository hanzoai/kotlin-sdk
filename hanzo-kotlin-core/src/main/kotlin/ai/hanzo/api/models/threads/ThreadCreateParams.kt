...
private constructor(
    ...
    companion object {
        ...
        fun none(): ThreadCreateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(threadCreateParams: ThreadCreateParams) = apply {
            ...
            additionalBodyProperties = threadCreateParams.additionalBodyProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ThreadCreateParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ThreadCreateParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
