...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): CredentialDeleteResponse =
            CredentialDeleteResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CredentialDeleteResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "CredentialDeleteResponse{additionalProperties=$additionalProperties}"
}
