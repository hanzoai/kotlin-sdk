...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ModelAddParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(modelAddParams: ModelAddParams) = apply {
            body = modelAddParams.body.toBuilder()
            additionalHeaders = modelAddParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [ModelAddParams].
         *
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (models.asKnown()?.size ?: 0) + (if (teamId.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ModelAddParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ModelAddParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
