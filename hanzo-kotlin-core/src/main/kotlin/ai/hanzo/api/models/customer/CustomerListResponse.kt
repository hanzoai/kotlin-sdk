...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerListResponse: CustomerListResponse) = apply {
            ...
            userId = customerListResponse.userId
            alias = customerListResponse.alias
            allowedModelRegion = customerListResponse.allowedModelRegion
            defaultModel = customerListResponse.defaultModel
            llmBudgetTable = customerListResponse.llmBudgetTable
            spend = customerListResponse.spend
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerListResponse && blocked == other.blocked && userId == other.userId && alias == other.alias && allowedModelRegion == other.allowedModelRegion && defaultModel == other.defaultModel && llmBudgetTable == other.llmBudgetTable && spend == other.spend && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CustomerListResponse{blocked=$blocked, userId=$userId, alias=$alias, allowedModelRegion=$allowedModelRegion, defaultModel=$defaultModel, llmBudgetTable=$llmBudgetTable, spend=$spend, additionalProperties=$additionalProperties}"
}
