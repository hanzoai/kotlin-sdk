...
private constructor(
     ...
     */
    fun litellmParams(): LitellmParams = body.litellmParams()
     ...
     */
    fun _litellmParams(): JsonField<LitellmParams> = body._litellmParams()
    ...
    class Builder internal constructor() {
        ...
        /** LiteLLM Params with 'model' requirement - used for completions */
        fun litellmParams(litellmParams: LitellmParams) = apply {
            body.litellmParams(litellmParams)
        }
    ...
    private constructor(
         ...
         */
        fun litellmParams(): LitellmParams = litellmParams.getRequired("litellm_params")
        ...
        class Builder internal constructor() {
            ...
            fun litellmParams(litellmParams: LitellmParams) =
                litellmParams(JsonField.of(litellmParams))
            ...
            fun build(): Body =
                Body(
                    checkRequired("litellmParams", litellmParams),
        ...
        override fun toString() =
            "Body{litellmParams=$litellmParams, modelInfo=$modelInfo, modelName=$modelName, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ModelCreateParams &&
            body == other.body &&
