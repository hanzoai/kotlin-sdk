...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = generateKeyResponse.litellmBudgetTable().convert(MyClass::class.java)
     * ```
     */
    @JsonProperty("litellm_budget_table")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(generateKeyResponse: GenerateKeyResponse) = apply {
            ...
            allowedPassthroughRoutes =
                generateKeyResponse.allowedPassthroughRoutes.map { it.toMutableList() }
            allowedRoutes = generateKeyResponse.allowedRoutes.map { it.toMutableList() }
            allowedVectorStoreIndexes =
                generateKeyResponse.allowedVectorStoreIndexes.map { it.toMutableList() }
            ...
            createdAt = generateKeyResponse.createdAt
            ...
            litellmBudgetTable = generateKeyResponse.litellmBudgetTable
            ...
            objectPermission = generateKeyResponse.objectPermission
            organizationId = generateKeyResponse.organizationId
            permissions = generateKeyResponse.permissions
            prompts = generateKeyResponse.prompts.map { it.toMutableList() }
            routerSettings = generateKeyResponse.routerSettings
            rpmLimit = generateKeyResponse.rpmLimit
            rpmLimitType = generateKeyResponse.rpmLimitType
            ...
            tpmLimitType = generateKeyResponse.tpmLimitType
            updatedAt = generateKeyResponse.updatedAt
