...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = generateKeyResponse.aliases().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = generateKeyResponse.config().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = generateKeyResponse.llmBudgetTable().convert(MyClass::class.java)
     * ```
     */
    @JsonProperty("llm_budget_table")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = generateKeyResponse.metadata().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = generateKeyResponse.modelMaxBudget().convert(MyClass::class.java)
     * ```
     */
    @JsonProperty("model_max_budget")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = generateKeyResponse.modelRpmLimit().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = generateKeyResponse.modelTpmLimit().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = generateKeyResponse.permissions().convert(MyClass::class.java)
     * ```
     */
