...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddAddAllowedIpParams].
         *
    ...
    /** A builder for [AddAddAllowedIpParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(addAddAllowedIpParams: AddAddAllowedIpParams) = apply {
            ipAddress = addAddAllowedIpParams.ipAddress
            additionalHeaders = addAddAllowedIpParams.additionalHeaders.toBuilder()
            additionalQueryParams = addAddAllowedIpParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AddAddAllowedIpParams].
         *
         ...
         */
        fun build(): AddAddAllowedIpParams =
            AddAddAllowedIpParams(
