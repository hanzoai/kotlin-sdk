...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = organizationDeleteResponse.metadata().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationDeleteResponse].
         *
    ...
    /** A builder for [OrganizationDeleteResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(organizationDeleteResponse: OrganizationDeleteResponse) = apply {
            budgetId = organizationDeleteResponse.budgetId
            createdAt = organizationDeleteResponse.createdAt
            createdBy = organizationDeleteResponse.createdBy
            models = organizationDeleteResponse.models.map { it.toMutableList() }
            updatedAt = organizationDeleteResponse.updatedAt
            updatedBy = organizationDeleteResponse.updatedBy
            llmBudgetTable = organizationDeleteResponse.llmBudgetTable
            members = organizationDeleteResponse.members.map { it.toMutableList() }
            metadata = organizationDeleteResponse.metadata
            organizationAlias = organizationDeleteResponse.organizationAlias
            organizationId = organizationDeleteResponse.organizationId
            spend = organizationDeleteResponse.spend
            teams = organizationDeleteResponse.teams.map { it.toMutableList() }
            additionalProperties = organizationDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationDeleteResponse].
         *
         ...
         */
        fun build(): OrganizationDeleteResponse =
    ...
    fun validate(): OrganizationDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = llmBudgetTable.modelMaxBudget().convert(MyClass::class.java)
         * ```
         */
        @JsonProperty("model_max_budget")
        @ExcludeMissing
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = member.user().convert(MyClass::class.java)
         * ```
         */
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = team.metadata().convert(MyClass::class.java)
         * ```
         */
        @JsonProperty("metadata") @ExcludeMissing fun _metadata(): JsonValue = metadata
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrganizationDeleteResponse &&
            budgetId == other.budgetId &&
            createdAt == other.createdAt &&
            createdBy == other.createdBy &&
            models == other.models &&
