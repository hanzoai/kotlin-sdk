...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = spendListTagsResponse.metadata().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = spendListTagsResponse.requestTags().convert(MyClass::class.java)
     * ```
     */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SpendListTagsResponse &&
            apiKey == other.apiKey &&
