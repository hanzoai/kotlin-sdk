...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SpendListTagsResponse].
         *
    ...
    /** A builder for [SpendListTagsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(spendListTagsResponse: SpendListTagsResponse) = apply {
            apiKey = spendListTagsResponse.apiKey
            callType = spendListTagsResponse.callType
            endTime = spendListTagsResponse.endTime
            messages = spendListTagsResponse.messages
            requestId = spendListTagsResponse.requestId
            response = spendListTagsResponse.response
            startTime = spendListTagsResponse.startTime
            apiBase = spendListTagsResponse.apiBase
            cacheHit = spendListTagsResponse.cacheHit
            cacheKey = spendListTagsResponse.cacheKey
            completionTokens = spendListTagsResponse.completionTokens
            metadata = spendListTagsResponse.metadata
            model = spendListTagsResponse.model
            promptTokens = spendListTagsResponse.promptTokens
            requestTags = spendListTagsResponse.requestTags
            requesterIpAddress = spendListTagsResponse.requesterIpAddress
            spend = spendListTagsResponse.spend
            totalTokens = spendListTagsResponse.totalTokens
            user = spendListTagsResponse.user
            additionalProperties = spendListTagsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SpendListTagsResponse].
         *
         ...
         */
        fun build(): SpendListTagsResponse =
    ...
    fun validate(): SpendListTagsResponse = apply {
        if (validated) {
            return@apply
        }
        ...
        internal class Deserializer : BaseDeserializer<EndTime>(EndTime::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): EndTime {
                ...
                tryDeserialize(node, jacksonTypeRef<String>())?.let {
                    return EndTime(string = it, _json = json)
                }
                tryDeserialize(node, jacksonTypeRef<OffsetDateTime>())?.let {
                    return EndTime(offsetDate = it, _json = json)
                }

                return EndTime(_json = json)
            }
        }
    ...
    private constructor(
        ...
        internal class Deserializer : BaseDeserializer<Messages>(Messages::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Messages {
                ...
                tryDeserialize(node, jacksonTypeRef<String>())?.let {
                    return Messages(string = it, _json = json)
                }
                tryDeserialize(node, jacksonTypeRef<List<JsonValue>>())?.let {
                    return Messages(jsonValues = it, _json = json)
                }
                tryDeserialize(node, jacksonTypeRef<JsonValue>())?.let {
                    return Messages(jsonValue = it, _json = json)
                }
    ...
    private constructor(
        ...
        internal class Deserializer : BaseDeserializer<Response>(Response::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Response {
                ...
                tryDeserialize(node, jacksonTypeRef<String>())?.let {
                    return Response(string = it, _json = json)
                }
                tryDeserialize(node, jacksonTypeRef<List<JsonValue>>())?.let {
                    return Response(jsonValues = it, _json = json)
                }
                tryDeserialize(node, jacksonTypeRef<JsonValue>())?.let {
                    return Response(jsonValue = it, _json = json)
                }
    ...
    private constructor(
        ...
        internal class Deserializer : BaseDeserializer<StartTime>(StartTime::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): StartTime {
                ...
                tryDeserialize(node, jacksonTypeRef<String>())?.let {
                    return StartTime(string = it, _json = json)
                }
                tryDeserialize(node, jacksonTypeRef<OffsetDateTime>())?.let {
                    return StartTime(offsetDate = it, _json = json)
                }

                return StartTime(_json = json)
            }
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SpendListTagsResponse && apiKey == other.apiKey && callType == other.callType && endTime == other.endTime && messages == other.messages && requestId == other.requestId && response == other.response && startTime == other.startTime && apiBase == other.apiBase && cacheHit == other.cacheHit && cacheKey == other.cacheKey && completionTokens == other.completionTokens && metadata == other.metadata && model == other.model && promptTokens == other.promptTokens && requestTags == other.requestTags && requesterIpAddress == other.requesterIpAddress && spend == other.spend && totalTokens == other.totalTokens && user == other.user && additionalProperties == other.additionalProperties /* spotless:on */
    }
