...
private constructor(
    ...
    companion object {
        ...
        fun none(): EmbeddingCreateParams = builder().build()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EmbeddingCreateParams && model == other.model && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "EmbeddingCreateParams{model=$model, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
