...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): AssistantDeleteResponse =
            AssistantDeleteResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AssistantDeleteResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "AssistantDeleteResponse{additionalProperties=$additionalProperties}"
}
