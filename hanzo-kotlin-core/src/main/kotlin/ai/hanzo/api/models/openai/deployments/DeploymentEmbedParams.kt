...
private constructor(
    ...
    /** A builder for [DeploymentEmbedParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(deploymentEmbedParams: DeploymentEmbedParams) = apply {
            pathModel = deploymentEmbedParams.pathModel
            body = deploymentEmbedParams.body.toBuilder()
            additionalHeaders = deploymentEmbedParams.additionalHeaders.toBuilder()
            additionalQueryParams = deploymentEmbedParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DeploymentEmbedParams].
         *
         ...
         */
        fun build(): DeploymentEmbedParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeploymentEmbedParams &&
    ...
    override fun toString() =
        "DeploymentEmbedParams{pathModel=$pathModel, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
