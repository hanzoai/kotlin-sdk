...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): InfoListResponse = InfoListResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun toString() = "InfoListResponse{additionalProperties=$additionalProperties}"
}
