...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class ai.hanzo.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class ai.hanzo.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class ai.hanzo.api.** {
    <init>(...);
