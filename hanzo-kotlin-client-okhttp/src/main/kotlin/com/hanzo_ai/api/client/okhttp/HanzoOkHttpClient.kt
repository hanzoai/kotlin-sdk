...
import com.hanzo_ai.api.client.HanzoClientImpl
...
class HanzoOkHttpClient private constructor() {
    ...
    companion object {
        ...
        fun fromEnv(): HanzoClient = builder().fromEnv().build()
    }

    /** A builder for [HanzoOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [HanzoClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HanzoClient =
            HanzoClientImpl(
                clientOptions
                    .httpClient(
