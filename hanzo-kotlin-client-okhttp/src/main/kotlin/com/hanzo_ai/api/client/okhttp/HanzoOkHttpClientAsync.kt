...
import com.hanzo_ai.api.client.HanzoClientAsyncImpl
...
class HanzoOkHttpClientAsync private constructor() {
    ...
    /** A builder for [HanzoOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [HanzoClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HanzoClientAsync =
            HanzoClientAsyncImpl(
                clientOptions
                    .httpClient(
